...
import CheckupLogo from '../medical-checkup 1.svg';
import ApLogo from '../appointment 1.svg';
        ...
        <div>
           ...
           <section class="text-gray-600 body-font">
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                ...
                <h1 class="title-font sm:text-4xl text-3xl mb-4 font-larger text-gray-900 font-bold tracking-tighter">One Stop COVID-19 Support</h1>
                <p class="mb-8 leading-relaxed">One place with all your covid needs whether it be finding important resources, booking an appointment or even checking for COVID</p>
                ...
                <div class="flex lg:flex-row md:flex-col">
                    ...
                    <img src={CheckupLogo} class="w-8 h-10"/>
                ...
                <img class="object-cover object-center rounded" alt="hero" src={Homesvg}/>
                </div>
            </div>
            </section>
        </div>
